...
module.exports.browserClient = function(port, secret, name) {
  var THREE, aspect, camera, client, container, dom, far, fov, height, near, pointLight, radius, renderer, rings, scene, segments, sphere, sphereGeometry, sphereMaterial, width;
